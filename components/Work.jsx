    ...
    <section id="work" className="py-24 bg-dark">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          ...
          >
            Projets Sélectionnés <span className="text-gray-600 block md:inline">2023-24</span>
          </motion.h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              <Link
                ...
                className="w-full md:w-3/5 relative group overflow-hidden rounded-2xl cursor-pointer block"
              >
              ...
              <div className="w-full md:w-2/5">
                <div className="flex items-center gap-4 mb-4">
                  <span className="px-3 py-1 rounded-full border border-white/20 text-xs uppercase tracking-wider text-gray-400">{project.year}</span>
        ...
        <div className="mt-24 text-center">
          <button onClick={() => window.scrollTo(0, 0)} className="inline-block border border-white/20 px-8 py-4 rounded-full hover:bg-white hover:text-black transition-all text-sm font-bold uppercase tracking-widest">
